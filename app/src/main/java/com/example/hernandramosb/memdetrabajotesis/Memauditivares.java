...
public class Memauditivares extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memauditivares);
        textView = (TextView) findViewById(R.id.MATextVierCorrectas);
        textView1 = (TextView) findViewById(R.id.MATextVierIncorrectas);
