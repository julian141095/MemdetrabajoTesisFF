...
public class Paresdepalres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paresdepalres);
        textView = (TextView) findViewById(R.id.PPTextViewCorrectas);
        textView1 = (TextView) findViewById(R.id.PPTextViewIncorrectas);
